...
public class FitnessWithTreeSearch extends PacmanController {
    ...
    public MOVE getMove(Game game, long timeDue) {
        ...
        // Check if a new level has started
        ...
        // int elapsedTime = currentTime - totalElapsedTime;
        ...
        // Print or use the fitness score as needed
